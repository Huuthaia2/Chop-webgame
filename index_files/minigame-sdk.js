			...
			try {
				var e, t, s = r || function () {
					...
					let t = "minigame-config.json",
						s = !1;
					return e.has("mn_config") && (t = e.get("mn_config"), console.debug("[minigame] config: ", t), s = !0), !s && e.has("mn_channel") && (e = e.get("mn_channel"), console.debug("[minigame] channel: ", e), t = e + "-config.json"), t
				}();
